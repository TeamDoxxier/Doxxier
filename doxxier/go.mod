...
replace doxxier.tech/doxxier/models => ./lib/models
// replace doxxier.tech/doxxier/protos => /path/to/your/local/protos
// replace doxxier.tech/doxxier/server => /path/to/your/local/server
// replace doxxier.tech/doxxier/utils => /path/to/your/local/utils
// replace doxxier.tech/doxxier/web => /path/to/your/local/web
...
require (
	...
	gitlab.com/elixxir/client/v4 v4.7.4 // indirect
